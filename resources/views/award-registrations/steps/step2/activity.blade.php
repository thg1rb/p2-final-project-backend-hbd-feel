@php
    $activityTypes = old(
        'activity_types',
        session('award_registration.step2.activity_types', [])
    );
            ...
            <div class="space-y-2">
                <label class="flex items-start gap-2">
                    <input
                        ...
                        @checked(in_array('community', $activityTypes))>
                    <span class="text-sm text-gray-700">
                        ดำเนินกิจกรรมที่ก่อให้เกิดประโยชน์ต่อชุมชนหรือส่วนรวม
                    </span>
                </label>
                ...
                <label class="flex items-start gap-2">
                    <input
                        ...
                        value="competition"
                        class="mt-1 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500"
                        @checked(in_array('competition', $activityTypes))>
                    <span class="text-sm text-gray-700">
                        เข้าร่วมการแข่งขันทางวิชาการหรือศิลปวัฒนธรรมและได้รับรางวัล
                    </span>
                </label>
                ...
                <label class="flex items-start gap-2">
                    <input
                        ...
                        value="leadership"
                        class="mt-1 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500"
                        @checked(in_array('leadership', $activityTypes))>
                    <span class="text-sm text-gray-700">
                        ดำรงตำแหน่งผู้นำนิสิตหรือกรรมการบริหารองค์กรนิสิต
                    </span>
                </label>
            </div>
