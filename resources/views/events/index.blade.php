                    ...
                    <thead class="divide-y border-b bg-gray-100">
                        <tr class="divide-x">
                            <th class="px-6 py-3 text-center cursor-pointer hover:bg-gray-200 transition">
                                <a href="{{ getSortUrl('academic_year') }}"
                        ...
                        @forelse($events as $event)
                            <tr class="divide-x">
                                ...
                                <td class="px-6 py-3 text-center">
                                    {{ \Carbon\Carbon::parse($event->start_date)->addYears(543)->locale('th')->translatedFormat('j F Y') }}
                                </td>
                                <td class="px-6 py-3 text-center">
                                    {{ \Carbon\Carbon::parse($event->end_date)->addYears(543)->locale('th')->translatedFormat('j F Y') }}
                                </td>
                                ...
                                <td class="px-6 py-3 text-center">
                                    <x-dropdown align="right" width="48">
                                        ...
                                        <x-slot name="content">
                                            <x-dropdown-link :href="route('events.show', $event)"
                                                class="flex flex-row gap-x-2 justify-start items-center">
