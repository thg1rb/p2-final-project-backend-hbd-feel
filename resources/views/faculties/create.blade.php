<x-app-layout>
    <div class="p-10 flex flex-col gap-y-7">
        ...
        <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
            <h1 class="font-bold text-2xl mb-6">เพิ่มคณะใหม่</h1>

            <form action="{{ route('faculties.store') }}" method="POST" class="flex flex-col gap-y-4">
                @csrf
                <div>
                ...
                <div class="flex justify-end mt-4">
                    <button type="submit" class="px-6 py-2 bg-primary text-white rounded-md">บันทึกข้อมูล</button>
                </div>
            </form>
        </div>
    </div>
